...
func HumanNameGenerator() string {
	adjective1 := adjectives[random.Intn(len(adjectives))]
	adjective2 := adjectives[random.Intn(len(adjectives))]
...
var nouns = []string{"ape", "baboon", "badger", "bat", "bear", "bird", "bobcat", "bulldog",
